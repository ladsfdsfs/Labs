// Name: 				Date:
    ...
    public class Bumper
   {
    ...
    //hint: the "location" of the bumper begins at its top left corner.      
     ...
     public int getX(){return myX;} public int getY(){return myY;}  public int getHeight(){return myHeight;} public int getWidth(){return myWidth;} public Color getColor(){return myColor;}
