...
public class PanelPix extends JPanel
{
   ...
   /******************************************************************  8 */
      ...
      mirrorLR.addActionListener(new Listener_LR());
      east.add(mirrorLR);			
   /******************************************************************  9 */
      JButton mirrorUD = new JButton("Mirror Up-Down");
      mirrorUD.setEnabled(true);
      mirrorUD.addActionListener(new Listener_UD());
      east.add(mirrorUD);
   /****************************************************************** 10 */
...
private class Listener_LR implements ActionListener {
      public void actionPerformed(ActionEvent e) {
       display.LR();
       update( display.getXval(), display.getYval());
...
private class Listener_UD implements ActionListener {
      public void actionPerformed(ActionEvent e) {
       display.UD();
       update( display.getXval(), display.getYval());
...
private class Listener_RL implements ActionListener {
      public void actionPerformed(ActionEvent e) {
       display.flipRL();
       update( display.getXval(), display.getYval());
...
private class Listener_DU implements ActionListener {
      public void actionPerformed(ActionEvent e) {
       display.flipDU();
       update( display.getXval(), display.getYval());
