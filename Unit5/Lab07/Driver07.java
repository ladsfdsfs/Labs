...
public class Driver07
{
      ...
      while(choice != 7)
      {
         ...
         switch(choice)
         {
            ...
            case 3: display(array, new ByTrucks());
               break;
            case 4: display(array, new ByTotal());
               break;
            case 5: add(array);
               break;
            case 6: save(array);
   ...
   {	
      ...
      String cars=JOptionPane.showInputDialog("enter a num of cars");
      String truck=JOptionPane.showInputDialog("enter a num of trucks");
      
      int pos=search(array, name);
      
      array[pos].setCars(array[pos].getCars()+Integer.parseInt(cars));
      array[pos].setTrucks(array[pos].getTrucks()+Integer.parseInt(truck));
   ...
   public static int search(Salesperson[] array, String name)
   {
            ...
            if(array[a].getName().equals(name))
            return a;
   ...
   public static int findMin(Object[] array, int upper, Comparator c)
   {
      ...
      for(int a = 0; a<upper; a++)
         if(c.compare(array[a],array[minIndex])<0)
            minIndex=a;
      return minIndex;
   }
